...
public class DisplaysFormationOnCombatMap : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject DiplayPath = Instantiate(DisplayPath, formationPivot, Quaternion.identity);
    ...
    {
        Start();
        GetComponent<DisplaysFormationOnCombatMap>().enabled = true;
    }
    ...
    public void StopScript()
    {
        ...
        GetComponent<DisplaysFormationOnCombatMap>().enabled = false;
    ...
    public void DisplayFormation(string side, Vector3 target)
    {
        ...
        formationPivot = new Vector3(Mathf.Round(maxX), 1, Mathf.Round(averageZ));
